...
![](<../.gitbook/assets/image (3).png>)(0,0)을 선택할 경우 이 4가지 경우를 선택할 수 있습니다.\
...
이후 그래프를 더 파악해봅시다.\
![](<../.gitbook/assets/image (5).png>)(1,2)를 탐색해봤는데 더이상 갈 수 없다는 것을 알았습니다.\
이런 경우 다시 전으로 돌아와 (1,3)을 탐색하기 시작합니다. 이렇게 **이전으로 돌아오는 것**이 백트래킹의 두번째 중요한 특징입니다.
